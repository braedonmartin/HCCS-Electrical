                ...
                <div id="rev_slider_one" className="rev_slider fullwidthabanner" style={{ display: 'none' }} data-version="5.4.3.1">
                    <ul>
                        ...
                        <li data-index="rs-903" data-transition="fade" data-slotamount="default" data-hideafterloop={0} data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb={slide3} data-rotate={0} data-fstransition="fade" data-fsmasterspeed={300} data-fsslotamount={7} data-saveperformance="off" data-title data-param1 data-param2 data-param3 data-param4 data-param5 data-param6 data-param7 data-param8 data-param9 data-param10 data-description>
                            {/* MAIN IMAGE */}
                            <img src={slide2} alt="" className="rev-slidebg" data-bgfit="cover" data-bgparallax={10} data-bgposition="center center" data-bgrepeat="no-repeat" data-no-retina />
                            {/* LAYERS */}
                            {/* LAYER NR. 1 [ for overlay ] */}
